$(function () {
    ...
    setTimeout(function() {
        $('.logo__notify').removeClass('closed')
    }, 2000);
    ...
    $('.team__inner-more').on('click', function(){
        $('.team__item-wrapper').removeClass('closed')
        $('.team__item').removeClass('closed')
        $(this).addClass('closed')
        $('.team__item-social').removeClass('closed')
        $('.team__items').addClass('all-active')
    })
